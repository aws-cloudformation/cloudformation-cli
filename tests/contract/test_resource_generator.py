...
def test_generate_integer_strategy():
    int_schema = {"type": "integer", "minimum": 0, "maximum": 16}
...
def test_generate_string_regex_strategy():
    string_schema = {"type": "string", "pattern": "^foo+bar+$"}
...
def test_generate_array_strategy_items():
