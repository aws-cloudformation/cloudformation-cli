...
def generate(env, resource_def, project_settings):
    ...
    templates_and_outputs = {
        "handlers/{}Handler.java".format(handler_type): handler_file.format(
            resource_name, handler_type
        )
    ...
    templates_and_outputs.update(
        {
            ...
            "utils/ResourceResponseReturner.java": utils_file.format(
                "ResourceResponseReturner"
            ),
    ...
    templates_and_outputs.update(
        {
            "unit/{}HandlerUnitTests.java".format(handler_type): unit_file.format(
                handler_type
            )
            for handler_type in curdl
        }
