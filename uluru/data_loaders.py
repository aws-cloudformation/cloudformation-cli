...
def load_resource_spec(resource_spec_file):
    ...
    try:
        ...
        LOG.error('Could not load the provided resource specification: %s', e)
        raise
        # TODO: error handling, decode errors have 'msg', 'doc', 'pos'

    with pkg_resources.resource_stream(
            __name__,
            'data/resource_specification_schema.json') as f:
    ...
    try:
        ...
        LOG.error('The provided resource specification is invalid: %s', e)
...
def load_project_settings(language, project_settings_file):
    ...
    if project_settings_file:
        try:
            ...
            LOG.error('Could not load the provided project settings: %s', e)
            raise
            # TODO: error handling, decode errors have 'msg', 'doc', 'pos'
        else:
    ...
    try:
        ...
        LOG.error('The provided project settings are invalid: %s', e)
        raise  # TODO: error handling
