...
def contract_delete_ack(event_listener, transport, resource_def):
...
def contract_delete_create(event_listener, transport, test_resource, resource_def):
...
def contract_delete_read(event_listener, transport, test_resource, resource_def):
    create_terminal_event = contract_utils.create_resource(
        event_listener, transport, test_resource
    )
    created_resource = create_terminal_event["resources"][0]
...
def contract_delete_delete(event_listener, transport, test_resource, resource_def):
    create_terminal_event = contract_utils.create_resource(
        event_listener, transport, test_resource
    )
    created_resource = create_terminal_event["resources"][0]
