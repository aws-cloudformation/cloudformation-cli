...
class ResourceGenerator:
    def __init__(self, resource_def):
        self.strategy = self._generate_object_strategy(resource_def)
    ...
    @staticmethod
    def _generate_number_strategy(number_schema, strategy):
        minimum = number_schema.get("minimum")
        maximum = number_schema.get("maximum")
    ...
    def _generate_property_strategy(cls, prop):
        ...
        if json_type == "integer":
            strategy = cls._generate_number_strategy(prop, integers)
        elif json_type == "number":
            strategy = cls._generate_number_strategy(prop, decimals)
