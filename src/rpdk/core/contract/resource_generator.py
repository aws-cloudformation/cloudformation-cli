...
STRING_FORMATS = {
    ...
    "date-time": "^(\d{4})-(0[1-9]|1[0-2])-(\d{2})T(?:[01]\d|2[0123]):(?:[0-5]\d):(?:[0-5]\d)(?:\.\d+)?(?:Z|[+-](?:[01]\d|2[0123]):[0-5]\d)$",
    "date": "^(\d{4})-(0[1-9]|1[0-2])-(\d{2})$",
    "time": "^(?:[01]\d|2[0123]):(?:[0-5]\d):(?:[0-5]\d)(?:\.\d+)?(?:Z|[+-](?:[01]\d|2[0123]):[0-5]\d)$",
    "email": "^.+@[^\.].*\.[a-z]{2,}$",
}
